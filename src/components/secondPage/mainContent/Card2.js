...
const Card2 = () => {
  return (
    <div className='w-[615px] h-[152px] mt-[20px]'>

        <p className='text-[12px] text-white mb-[3px]' >Onboarding updates <span className='text-[12px] text-[#999fad]'>(1)</span></p>
        ...
        <div className='w-full h-[120px] flex items-center bg-[#222831] rounded'>
            ...
            <div className='p-[10px] py-[16px]'> 
                <p className='text-white text-[15px]'> Open your RazorpayX account.</p>
                ...
                <div className='flex items-center text-[12px] bg-blue-500 p-[4px] px-[8px] rounded w-[122px]'>
                <button className=' px-[1px] text-white text-[11px]'>Start application </button>
                 <span className=' text-white'><GoArrowRight/></span>
                </div>
